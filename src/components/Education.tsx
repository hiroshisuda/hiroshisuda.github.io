      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="mt-12 space-y-4">
          {education.map((entry, i) => (
            ...
            >
              <div className="shrink-0 text-amber-500 dark:text-amber-400 mt-1">
              ...
              <div className="flex-1">
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-1 mb-2">
                  <div>
                    ...
                    <p className="text-amber-600 dark:text-amber-400 text-sm font-medium mt-0.5">
...
function SectionHeading({ children }: { children: React.ReactNode }) {
  return (
    <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100 flex items-center gap-4">
      <span className="text-amber-500 dark:text-amber-400 font-mono text-xl">04.</span>
      {children}
